                ...
                <div className="space-y-6">
                  <div className="report-card rounded-[2rem] p-6 lg:p-8">
                    ...
                    <div className="mt-5 flex items-end justify-between gap-4">
                      <div>
                        <p
                          className={`font-['NeueMachina'] text-7xl leading-none ${scoreTone(report.overallScore)}`}
                        >
                          {report.overallScore}
                        </p>
                    ...
                    <div className="mt-5 grid gap-4 md:grid-cols-2">
                      <div className="rounded-3xl border border-black/10 bg-white/60 p-4">
                        ...
                        <p className="mt-2 text-3xl">
                          {formatScore(mobile?.performanceScore ?? null)}
                        </p>
                      ...
                      <div className="rounded-3xl border border-black/10 bg-white/60 p-4">
                        ...
                        <p className="mt-2 text-3xl">
                          {formatScore(desktop?.performanceScore ?? null)}
                        </p>
                        <p className="mt-3 text-sm text-black/60">
                      ...
                      <div className="rounded-3xl border border-black/10 bg-white/60 p-4">
                        ...
                        <p className="mt-2 text-3xl">
                          {formatScore(gtmetrix?.performanceScore ?? null)}
                        </p>
                        <p className="mt-3 text-sm text-black/60">
                          Fully loaded {formatMilliseconds(gtmetrix?.fullyLoadedTime ?? null)} ·
                          Peso {formatBytes(gtmetrix?.pageBytes ?? null)}
                        </p>
                      </div>
                      <div className="rounded-3xl border border-black/10 bg-white/60 p-4">
                        <p className="text-xs uppercase tracking-[0.2em] text-black/45">
                        ...
                        <p className="mt-2 text-3xl">
                          {formatCLS(
                            mobile?.cumulativeLayoutShift ??
                              gtmetrix?.cumulativeLayoutShift ??
                              null
                          )}
                        </p>
                        <p className="mt-3 text-sm text-black/60">
